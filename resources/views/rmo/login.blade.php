...
<link href="{{ asset('rmo/css/loading.css') }}" rel="stylesheet">
...
<img class="ie10andup" src="{{ asset('rmo/images/mgc-asb-logo.svg') }}" alt="Mentor Graphics, A Siemens Business logo" title="Log in using your Mentor network credentials">
<div class="container">
...
$(document).ready(function()
{
	...
	$("#loginform").submit(
		function (e)
		{
			...
			$.ajax({
				type:"POST",
				url:'{{route("rmo.authenticate")}}',
				cache: false,
				data:formdata,
				success: function(response)
				{
					window.location.href = "{{route('rmo.planner')}}";
				},
