 ...
 */var Dygraph=function Dygraph(div,data,opts){this.lastrow = data.length-1;this.__init__(div,data,opts);};Dygraph.NAME = "Dygraph";Dygraph.VERSION = "2.0.0"; // Various default values
...
this.setSelection(this.lastrow);
 ...
 */Dygraph.prototype.setSelection = function(row,opt_seriesName,opt_locked){ // Extract the points we've selected
	...
	for(var setIdx=0;setIdx < this.layout_.points.length;++setIdx) 
	{
        ...
        this.lastPoint = this.layout_.points[setIdx];
